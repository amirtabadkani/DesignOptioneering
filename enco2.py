...
with st.sidebar:
    st.image('./img/DMA_white.png',use_container_width=True,output_format='PNG')
...
with st.container():
    ...
    with col1:
        ""
    with col2:
        st.image(loadImages()[0], caption='Selected Design Iteration', use_container_width = False)
    with col3:
        ""
    with col4:
        st.image(loadImages()[1], caption='Reference Case', use_container_width = False)
    ...
    chep_pcm.update_layout(coloraxis_showscale=False,
                               font=dict(color="black"),   # make labels black
                                paper_bgcolor="white",
                                plot_bgcolor="white",
